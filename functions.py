...
# predictiong coins by image path
...
def detect_many_coins_for_regression(image_files, classifier):
    ...
    for i in image_files:
        ...
        for (x,y,r) in detected_circles[0,:]:
            ...
            #x and y is small
            if(x<r+10 and y<r+10):
                final_output = output[0:y+r+1, 0:x+r+1]
            #x and y is big
            elif(y+r+10>480 and x+r+10>640):
                final_output = output[y-r-1:480, x-r-1:640]
                #x is small and y is big

            elif(x<r+10 and y+r+10>480):
                final_output = output[y-r-1:480, 0:x+r+1]
                #x is big and y is small
            elif(x+r+10>640 and y<r+10 ):
                final_output = output[0:y+r+1, x-r-1:640]
            #y is big
            elif((y+r+10>480 and x-r-10>0 ) or (y+r+10>480 and x+r+10<640)):
                final_output = output[y-r-1:480, x-r-1:x+r+1]
                #y is small
            elif((y<r+10 and x-r-10>0) or (y<r+10 and x+r+10<640)):
                final_output = output[0:y+r+1, x-r-1:x+r+1]
            #x is big
            elif((x+r+10>640 and y-r-10>0) or( x+r+10>640 and y+r+10<480)):
                final_output = output[y-r-1:y+r+1, x-r-1:640]
            #x is small
            elif((x<r+10 and y-r-10>0 ) or (x<r+10 and y+r+10<480)):
                final_output = output[y-r-1:y+r+1, 0:x+r+1]
            else:
                final_output = output[y-r-1:y+r+1, x-r-1:x+r+1]
