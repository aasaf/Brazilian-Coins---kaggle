from Include.functions import build_model,extract_labels,convert_image_files_to_array
from Include.functions import detect_many_coins_for_regression,detect_classification_coins
